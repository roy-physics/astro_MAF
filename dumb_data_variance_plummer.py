...
for train_size in train_sizes:
    ...
    for i in range (0,n_flow):
        ...
        path_temp_wgt = "./wgt_maf_"+str(train_size)+"_data"#path_temp_wgt = path_temp_wgts[i]
        path_log_file = "./wgt_maf_"+str(train_size)+"_data.log"#path_log_file = path_log_files[i]
        ...
        with open(path_log_file, 'w') as fp:
            ...
            np.save(str(train_size)+'_datavariance_losses.npy',losses) # updates and saves best loss at the end of every flow training loop
